...
```bash
nextflow run nf-core/neutronstar -profile <docker/singularity/conda/institute> --reads '*_R{1,2}.fastq.gz' --genome GRCh37
```
...
The nf-core/neutronstar pipeline comes with documentation about the pipeline, found in the `docs/` directory:
